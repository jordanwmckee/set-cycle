...
let exercise6 = Exercise(name: "Running", video: "https://www.youtube.com/watch?v=XXX", reps: [])
let exercise7 = Exercise(name: "Plank", video: "https://www.youtube.com/watch?v=XXX", reps: [])
let exercise8 = Exercise(name: "Burpees", video: "https://www.youtube.com/watch?v=XXX", reps: [])
let exercise9 = Exercise(name: "Jumping Jacks", video: "https://www.youtube.com/watch?v=XXX", reps: [])
let exercise10 = Exercise(name: "Mountain Climbers", video: "https://www.youtube.com/watch?v=XXX", reps: [])
...
let exercise11 = Exercise(name: "Dumbbell Rows", video: "https://www.youtube.com/watch?v=XXX", reps: [Rep(weight: 35, reps: 12)])
let exercise12 = Exercise(name: "Push-Ups", video: "https://www.youtube.com/watch?v=XXX", reps: [])
let exercise13 = Exercise(name: "Dumbbell Bench Press", video: "https://www.youtube.com/watch?v=XXX", reps: [Rep(weight: 40, reps: 10)])
let exercise14 = Exercise(name: "Pull-Ups", video: "https://www.youtube.com/watch?v=XXX", reps: [])
let exercise15 = Exercise(name: "Lateral Raises", video: "https://www.youtube.com/watch?v=XXX", reps: [Rep(weight: 15, reps: 12)])
...
let exercise16 = Exercise(name: "Leg Press", video: "https://www.youtube.com/watch?v=XXX", reps: [Rep(weight: 200, reps: 10)])
let exercise17 = Exercise(name: "Lunges", video: "https://www.youtube.com/watch?v=XXX", reps: [])
let exercise18 = Exercise(name: "Calf Raises", video: "https://www.youtube.com/watch?v=XXX", reps: [Rep(weight: 50, reps: 15)])
let exercise19 = Exercise(name: "Squats", video: "https://www.youtube.com/watch?v=XXX", reps: [Rep(weight: 95, reps: 8)])
let exercise20 = Exercise(name: "Hamstring Curls", video: "https://www.youtube.com/watch?v=XXX", reps: [Rep(weight: 40, reps: 10)])

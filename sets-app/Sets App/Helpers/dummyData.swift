...
let dummyPlans: [Plan] = [
   Plan(name: "Plan 1", description: "Description 1", exercises: [
      Exercise(name: "Exercise 1", reps: dummyReps),
      Exercise(name: "Exercise 2", reps: dummyReps)
   ]),
   Plan(name: "Plan 2", description: "Description 2", exercises: [
      Exercise(name: "Exercise 3", reps: dummyReps),
      Exercise(name: "Exercise 4", reps: dummyReps)
   ]),
   Plan(name: "Plan 3", description: "Description 3", exercises: [
      Exercise(name: "Exercise 5", reps: dummyReps)
   ]),
   Plan(name: "Plan 4", description: "Description 4", exercises: [
      Exercise(name: "Exercise 6", reps: dummyReps)
   ]),
   Plan(name: "Plan 5", description: "Description 5", exercises: [
      Exercise(name: "Exercise 7", reps: dummyReps),
      Exercise(name: "Exercise 8", reps: dummyReps)
   ]),
   Plan(name: "Plan 6", description: "Description 6", exercises: [
      Exercise(name: "Exercise 9", reps: dummyReps)
   ]),
   Plan(name: "Plan 7", description: "Description 7", exercises: [
      Exercise(name: "Exercise 10", reps: dummyReps),
      Exercise(name: "Exercise 11", reps: dummyReps)
   ])
   ]
